...
export default function ChatBot({ isOpen, onToggle, userRole, language }) {
  ...
  const translations = {
    en: {
      ...
      typing: "AI analyzing...",
      welcomeFarmer:
        "Hello! I'm your AI Farm Assistant powered by DialoGPT AI model. I can:\n\n🌾 Recommend crops based on soil parameters\n🔬 Detect plant diseases from images\n📊 Analyze soil conditions\n💰 Provide market insights\n💬 Answer your farming questions using AI\n\nHow can I help you today?",
      welcomeBuyer:
        "Hello! I'm AgriBot, your shopping assistant. I can help you find fresh produce, track orders, and connect with farmers. What would you like to know?",
      soilPrompt:
        "Please provide your soil parameters:\n\nRequired: pH, Nitrogen, Phosphorous, Potassium\nOptional: Moisture, Temperature, Humidity, Rainfall\n\nI'll recommend the best crops for your conditions.",
      imagePrompt:
        "Upload a clear image of the affected plant leaf or stem. I'll analyze it using ResNet AI model to detect diseases and provide treatment recommendations.",
      analyzingSoil: "Analyzing soil parameters using XGBoost model...",
      analyzingImage: "Analyzing plant image using ResNet model...",
      fertilizerAdvice:
        "For your wheat crop, I recommend using NPK fertilizer (10:26:26) at 50kg per acre. Apply it during the tillering stage for best results.",
      todayPrice:
        "Today's market prices:\n🌾 Wheat: ₹25-28/kg\n🍅 Tomatoes: ₹40-45/kg\n🧅 Onions: ₹35-38/kg",
      weatherToday:
        "Today's weather: Sunny, 28°C. Perfect conditions for spraying pesticides. No rain expected for next 3 days.",
      pmKisan:
        "PM-KISAN scheme provides ₹6,000 per year to farmer families. Next installment due in March 2024. You can apply online at pmkisan.gov.in",
    },
    hi: {
      ...
      welcomeFarmer:
        "नमस्कार! मैं एग्रीबॉट हूं, आपका कृषि सहायक। मैं फसल सलाह, मौसम अपडेट, बाज़ार मूल्य और सरकारी योजनाओं में आपकी मदद कर सकता हूं। आज मैं आपकी कैसे सहायता कर सकता हूं?",
      welcomeBuyer:
        "नमस्कार! मैं एग्रीबॉट हूं, आपका खरीदारी सहायक। मैं ताजी उपज खोजने, ऑर्डर ट्रैक करने और किसानों से जुड़ने में आपकी मदद कर सकता हूं। आप क्या जानना चाहते हैं?",
      fertilizerAdvice:
        "आपकी गेहूं की फसल के लिए, मैं NPK उर्वरक (10:26:26) 50 किलो प्रति एकड़ की सिफारिश करता हूं। बेहतर परिणामों के लिए इसे कल्ले निकलने के समय डालें।",
      todayPrice:
        "आज के बाज़ार भाव:\n🌾 गेहूं: ₹25-28/किलो\n🍅 टमाटर: ₹40-45/किलो\n🧅 प्याज: ₹35-38/किलो",
      weatherToday:
        "आज का मौसम: धूप, 28°से। कीटनाशक छिड़काव के लिए उत्तम स्थितियां। अगले 3 दिन बारिश की संभावना नहीं।",
      pmKisan:
        "PM-KISAN योजना किसान परिवारों को प्रति वर्ष ₹6,000 प्रदान करती है। अगली किस्त मार्च 2024 में। आप pmkisan.gov.in पर ऑनलाइन आवेदन कर सकते हैं।",
    },
  };
  ...
  const farmerQuickReplies = [
    ...
    { id: "disease", text: t("diseaseManagement"), icon: Bug },
  ...
  const quickReplies =
    userRole === "farmer" ? farmerQuickReplies : buyerQuickReplies;
  ...
  const analyzeSoilParameters = (params) => {
    ...
    const hasRequiredParams =
      params.pH && params.nitrogen && params.phosphorous && params.potassium;
    ...
    const diseases = [
      {
        ...
        treatment: {
          ...
          preventive:
            "Remove infected leaves, maintain plant spacing, avoid overhead irrigation",
        },
      },
      {
        name: "Leaf Spot",
